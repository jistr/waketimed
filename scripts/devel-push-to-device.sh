...
CONFIG_DIR=/opt/waketimed-devel/etc
DIST_DIR=/opt/waketimed-devel/lib
STATE_DIR=/opt/waketimed-devel/var
...
ssh $WAKETIMED_DEVICE_SSH chmod -R u=rwX,g=rX,o=rX "$DIST_DIR"
